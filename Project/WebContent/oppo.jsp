		...
		<div class="h-content">
			...
			<div class="product-bottom">
				...
				<div class="product-bottom-2">
					...
					<%
						ArrayList<Product> listProducOppo = new DAOProduct().getListProduct("select* from productoppo");
					%>
					<!--chinh tu day  -->
					<div class="hien-thi-danh-sach-san-pham">
						<%
							for (Product p : listProducOppo) {
						%>
						<div class="khung-anh">
					...
					<div class="clean">
						<div class="trang-san-pham-tiep-theo">
							<div class="btn-group">
								<input type="button" value="Đầu" /> <input type="button"
									value="1" /> <input type="button" value="2" /> <input
									type="button" value="3" /> <input type="button" value="Cuối" />
							</div>
						</div>
					</div>
				</div>
