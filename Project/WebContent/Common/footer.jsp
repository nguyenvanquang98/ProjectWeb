...
<body>
		...
		<div class="m-row">
			...
			<div class="fo-col">
				<ul>
					...
					<li class="contact">0000 0000</li>
					<li>
						<p class="p-lang">Lựa chọn ngôn ngữ:</p> <select name="languages"
						id="lang">
	...
	<div class="inf">
		<span>© 2018 Công Ty Cổ Phần QLTAStore / Địa chỉ: TP. Hồ Chí Minh / GPĐKKD số 0111xxxx do Sở KHĐT TP.HCM
			cấp ngày 08/03/2012. GP số 47/GP-TTĐT. Điện thoại: (028)73023456.
			Email: qltastore@fpt.com.vn. Chịu trách nhiệm nội dung: QLTA
		</span>
	</div>
	<div class="end"></div>
</body>
