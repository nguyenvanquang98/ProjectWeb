		...
		<div class="h-content">
			...
			<div class="product-bottom">
				...
				<div class="product-bottom-2">
					...
					<%
						ArrayList<Product> listProducIphone = new DAOProduct().getListProductIP();
					%>
					<!--chinh tu day  -->
					<div class="hien-thi-danh-sach-san-pham">
						<%
							for (int i = 0; i < listProducIphone.size(); i++) {
						%>
						<div class="khung-anh">

							<a class="anh"
								href="<%=request.getContextPath()%>/ControllerProduct?id=<%=listProducIphone.get(i).getId()%>">
								<img src="<%=listProducIphone.get(i).getImg()%>" />

								<div class="box-thong-tin-san-pham">
									<span><%=listProducIphone.get(i).getName()%></span>
									<p><%=formatter.format(listProducIphone.get(i).getPrice())%><sup>đ</sup>
									</p>
									<!-- Ket thuc -->
