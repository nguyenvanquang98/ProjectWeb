		...
		<div class="h-content">
			...
			<div class="product-bottom">
				...
				<div class="product-bottom-2">
					...
					<%
						ArrayList<Product> listProducXiaomi = new DAOProduct().getListProductXiaomi();
					%>
					<!--chinh tu day  -->
					<div class="hien-thi-danh-sach-san-pham">
						<%
							for (int i = 0; i < listProducXiaomi.size(); i++) {
						%>
						<div class="khung-anh">

							<a class="anh"
								href="<%=request.getContextPath()%>/ControllerProduct?id=<%=listProducXiaomi.get(i).getId()%>">
								<img src="<%=listProducXiaomi.get(i).getImg()%>" />

								<div class="box-thong-tin-san-pham">
									<span><%=listProducXiaomi.get(i).getName()%></span>
									<p><%=formatter.format(listProducXiaomi.get(i).getPrice())%><sup>đ</sup>
									</p>
									<!-- Ket thuc -->
