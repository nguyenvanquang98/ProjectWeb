		...
		<div class="h-content">
			...
			<div class="product-bottom">
				...
				<div class="product-bottom-2">
					...
					<%
						ArrayList<Product> listProducSam = new DAOProduct().getListProductSam();
					%>
					<!--chinh tu day  -->
					<div class="hien-thi-danh-sach-san-pham">
						...
						<div class="khung-anh">
							...
							<a class="anh" href="<%=request.getContextPath()%>/ControllerProduct?id=<%=listProducSam.get(i).getId()%>"> <img src="<%=listProducSam.get(i).getImg()%>" />
