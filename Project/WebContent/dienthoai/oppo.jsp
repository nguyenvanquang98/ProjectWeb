		...
		<div class="h-content">
			...
			<div class="product-bottom">
				...
				<div class="product-bottom-2">
					...
					<%
						ArrayList<Product> listProducOppo = new DAOProduct().getListProductOppo();
					%>
					<!--chinh tu day  -->
					<div class="hien-thi-danh-sach-san-pham">
						<%
							for (int i = 0; i < listProducOppo.size(); i++) {
						%>
						<div class="khung-anh">

							<a class="anh"
								href="<%=request.getContextPath()%>/ControllerProduct?id=<%=listProducOppo.get(i).getId()%>">
								<img src="<%=listProducOppo.get(i).getImg()%>" />

								<div class="box-thong-tin-san-pham">
									<span><%=listProducOppo.get(i).getName()%></span>
									<p><%=formatter.format(listProducOppo.get(i).getPrice())%><sup>đ</sup>
									</p>
									<!-- Ket thuc -->
